package com.uncanny.camera2_timelapse;
...
public class LatestThumbnailGeneratorThread implements Runnable{
    ...
    public LatestThumbnailGeneratorThread(Context context){
